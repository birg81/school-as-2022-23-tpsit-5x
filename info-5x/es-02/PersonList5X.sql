...
INSERT INTO Place2Live(people, place, dt) VALUES
	...
	(69,	55,	CURRENT_DATE - INTERVAL FLOOR(18*RAND()) MONTH),
	(70,	7,	'2018-02-09'),
	(71,	1,	'2019-01-08'),
	(72,	36,	'2021-12-18'),
	(73,	61,	'2005-01-14'),
	...
	(79,	60,	CURRENT_DATE - INTERVAL FLOOR(3*RAND()) MONTH),
	(80,	67,	'2004-03-23'),
	(81,	48,	'2022-07-27'),
	(82,	78,	'2017-03-19'),
	(83,	32,	'2017-09-20'),
	(84,	54,	CURRENT_DATE - INTERVAL FLOOR(21*RAND()) DAY),
	(85,	4,	CURRENT_DATE - INTERVAL FLOOR(3*RAND()) MONTH),
	(86,	64,	'2008-01-01'),
	(87,	34,	CURRENT_DATE - INTERVAL FLOOR(3*RAND()) MONTH),
	(88,	1,	CURRENT_DATE - INTERVAL FLOOR(6*RAND()) MONTH),
	(89,	83,	CURRENT_DATE - INTERVAL FLOOR(3*RAND()) MONTH),
	(90,	67,	'2018-01-01');
